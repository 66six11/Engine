...
codemodel evidence 与 pure planner 边界也已实现。上游 catalog/index、lock update/apply、Artifact/Activation Plan、生产
catalog/lockfile 与 Editor Package Manager 尚未实现。
...
[ADR：Source Build Plan v1](adr-source-build-plan-v1.md)。
