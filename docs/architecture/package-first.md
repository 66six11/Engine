...
与 canonical logical IR 已实现。上游 catalog/index、lock update/apply、Build/Activation Plan、生产 catalog/lockfile 与
Editor Package Manager 尚未实现。
...
[ADR：Host Composition Plan v1](adr-host-composition-plan-v1.md)。
