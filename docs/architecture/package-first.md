...
v1 / Feature Set v2 schemas、validator、normalized writer 与 synthetic fixtures 已实现，但 resolver、生产 lockfile 与任何生产
Feature Set 尚未实现。Candidate source、exact graph、integrity byte domain 与 stale-lock 规则见
