...
当前唯一接受的 generated contract 仍是 Windows Development Host Template renderer 2 + Static Composition renderer 3 +
`asharia-static-factory-provider-v2`。本 Slice 不保留旧 provider、renderer、executor 或 schema adapter。
