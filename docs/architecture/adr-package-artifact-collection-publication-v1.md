...
[Editor Image、Engine Distribution 与原生组合 ADR](adr-editor-engine-distribution-and-native-composition.md) 为准。
...
1. 对 Host Composition、Source Build Plan、successful locked verification、Product Declaration snapshots 和 collection
