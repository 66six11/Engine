...
smoke、显式 culling/side-effect 标记和 renderer-basic 共享 builtin schema 已落地，下一步优先级调整为：补 RenderGraph 更细诊断、deferred destruction、
