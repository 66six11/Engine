...
引擎级系统边界和线程路线见 `docs/architecture/engine-systems.md`、`docs/architecture/frame-loop-threading.md`。其中反射、资产、scene/world、editor、script、input 和 build/cook/package 按本文阶段逐步进入；它们用于约束后续设计不要反向污染 RenderGraph、RHI 和 package 边界。
