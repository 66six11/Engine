...
- `asharia-editor` 已接入 Dear ImGui host、dockspace/menu、panel/action/event registry、
  ...
  ImGui texture registry、`--smoke-editor-shell`、`--smoke-editor-viewport` 和 `--smoke-editor-viewport-resize`。
