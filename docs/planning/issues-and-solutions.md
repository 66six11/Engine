...
- Grid spacing、major spacing、optional fade、opacity 和 color 已接入 editor user settings，并通过 Scene View request 进入
  ...
  bootstrap 用它处理新 settings 和旧 settings 缺省迁移；Editor Settings 已有最小 grid color 控件；后续再补 external manifest loader、更多设置 UI 和热更新。
