...
- Grid spacing、major spacing、optional fade 和 opacity 已接入 editor user settings，并通过 Scene View request 进入
  `BasicRenderViewOverlayDesc::worldGrid`；后续再补 manifest-backed 默认值、颜色、设置 UI 和热更新。
...
短期 (2-4 轮迭代):
  Grid manifest-backed settings (1.2)
