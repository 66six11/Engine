...
| 架构健康、构建与提交门禁 | [workflow/architecture-health.md](workflow/architecture-health.md)、[workflow/build.md](workflow/build.md)、[workflow/review.md](workflow/review.md) | current |
...
| 主题 | 文档 |
| --- | --- |
| 架构原则与 package 边界 | [architecture/architecture-principles.md](architecture/architecture-principles.md)、[architecture/package-first.md](architecture/package-first.md)、[Installable Package Manifest v2 ADR](architecture/adr-installable-package-manifest-v2.md)、[Project Manifest / Package Lock v2 硬切 ADR](architecture/adr-project-manifest-lock-v2-hard-cut.md)、[Package Candidate Discovery v1 ADR](architecture/adr-package-candidate-discovery-v1.md)、[Engine Distribution Package Catalog Snapshot v1 ADR](architecture/adr-engine-distribution-package-catalog-snapshot-v1.md)、[Project / Local Package Source Catalog v1 ADR](architecture/adr-project-local-package-source-catalog-v1.md)、[Package Resolver v1 ADR](architecture/adr-package-resolver-v1.md)、[Locked Graph Verification & Reuse v1 ADR](architecture/adr-package-lock-verification-v1.md)、[Package Lock Update Plan / Impact Preview v1 ADR](architecture/adr-package-lock-update-plan-v1.md)、[Package Lock Apply Preconditions v1 ADR](architecture/adr-package-lock-apply-preconditions-v1.md)、[Core Exclusive File Lock v1 ADR](architecture/adr-core-exclusive-file-lock-v1.md)、[Core Staged File Preparation v1 ADR](architecture/adr-core-staged-file-preparation-v1.md)、[Core Staged File Replacement v1 ADR](architecture/adr-core-staged-file-replacement-v1.md)、[Host Profile v1 ADR](architecture/adr-host-profile-v1.md)、[Host Composition Plan v1 ADR](architecture/adr-host-composition-plan-v1.md)、[Source Build Plan v1 ADR](architecture/adr-source-build-plan-v1.md)、[Package Product & Artifact Evidence v1 ADR](architecture/adr-package-product-artifact-evidence-v1.md)、[Engine Distribution Manifest v1 ADR](architecture/adr-engine-distribution-manifest-v1.md)、[Engine Distribution Assembly v1 ADR](architecture/adr-engine-distribution-assembly-v1.md)、[Installed Distribution Repair Verifier v1 ADR](architecture/adr-installed-distribution-repair-verifier-v1.md)、[Effective Session v1 ADR](architecture/adr-effective-session-v1.md)、[Activation Eligibility v1 ADR](architecture/adr-activation-eligibility-v1.md)、[ProcessScope Lifecycle v1 ADR](architecture/adr-process-scope-lifecycle-v1.md)、[ProcessScope Contribution Registry and Activation Lease v1 ADR](architecture/adr-process-scope-contribution-registry-and-activation-lease-v1.md)、[Static Typed Contribution Contract Bindings v1 ADR](architecture/adr-static-typed-contribution-contract-bindings-v1.md)、[Static Contribution Payload Accessors v1 ADR](architecture/adr-static-contribution-payload-accessors-v1.md)、[Editor Image / Engine Distribution ADR](architecture/adr-editor-engine-distribution-and-native-composition.md) |
...
| 架构健康与能力接入 | [workflow/architecture-health.md](workflow/architecture-health.md) |
...
3. [workflow/architecture-health.md](workflow/architecture-health.md)
4. [architecture/overview.md](architecture/overview.md)
5. [architecture/flow.md](architecture/flow.md)
6. [architecture/package-first.md](architecture/package-first.md)
7. [architecture/foundation-framework.md](architecture/foundation-framework.md)
8. [planning/system-architecture-roadmap.md](planning/system-architecture-roadmap.md)
