...
| 主题 | 文档 |
| --- | --- |
| 架构原则与 package 边界 | [architecture/architecture-principles.md](architecture/architecture-principles.md)、[architecture/package-first.md](architecture/package-first.md)、[Installable Package Manifest v2 ADR](architecture/adr-installable-package-manifest-v2.md) |
