...
HOST_REGISTRATION_SNAPSHOT_SCHEMA_VERSION = 1
...
class StaticFactoryRegistration:
    """One owning factory identity observed from its static provider."""
...
def _registration_from_data(value: dict[str, str]) -> StaticFactoryRegistration:
