...
public static partial class StudioEditorImageProducer
{
    ...
    [
        ...
        "selection_mask.frag.reflection.json",
        "selection_mask.frag.spv",
        "selection_outline.frag.reflection.json",
        "selection_outline.frag.spv",
        "selection_outline.vert.reflection.json",
        "selection_outline.vert.spv",
