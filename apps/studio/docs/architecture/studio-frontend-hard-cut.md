...
>
> 2026-08-13，#385又让现有Project panel成为只读catalog-backed Resource Browser：Application-owned
...
### 4.43 R6 Catalog-backed Resource Browser vertical slice card（current）
