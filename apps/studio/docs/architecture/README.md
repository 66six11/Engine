...
- [Studio 扩展模型](studio-extension-model.md)：Feature module、contribution、panel/provider 生命周期和隔离。
...
- [ADR-0003：用六个项目建立编译期边界](../adr/0003-studio-project-boundaries.md)

## 设计基线

[Studio Framework vNext Design](../superpowers/specs/2026-07-11-studio-framework-vnext-design.md) 记录本轮完整需求、备选方案、迁移阶段和验收条件。Architecture 文档把其中的稳定合同拆成开发者日常使用的专题说明。
