...
- public Dialog source/type properties 不含 Avalonia、Window、Control、delegate、`object` factory、native/Vulkan/Studio implementation vocabulary；
