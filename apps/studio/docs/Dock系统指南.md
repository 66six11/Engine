...
5. Selection Contract、Inspector Data Model、Project/Console 数据源接入
```
...
5. Selection Contract v0：定义 editor selection service、active context 和面板订阅边界。
6. Inspector Data Model v0：在 Selection Contract 后接入 read-only inspector 数据模型。
