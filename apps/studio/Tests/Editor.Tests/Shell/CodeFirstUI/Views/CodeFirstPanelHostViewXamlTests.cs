...
public sealed class CodeFirstPanelHostViewXamlTests
{
    ...
    [Fact]
    public void Code_first_vector3_field_uses_compact_component_styles()
    {
        var xaml = LoadSource("Shell", "CodeFirstUI", "Views", "CodeFirstPanelHostView.axaml");

        var vectorFieldStyle = GetStyle(xaml, "Style Selector=\"Grid.code-first-vector3-field\"");
    ...
    [Fact]
    public void Code_first_vector2_field_uses_compact_component_styles()
    {
        var xaml = LoadSource("Shell", "CodeFirstUI", "Views", "CodeFirstPanelHostView.axaml");

        var vectorFieldStyle = GetStyle(xaml, "Style Selector=\"Grid.code-first-vector2-field\"");
        var componentStyle = GetStyle(xaml, "Style Selector=\"NumericUpDown.code-first-vector-component\"");
